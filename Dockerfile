...
FROM ghcr.io/qemus/qemu:latest@sha256:2dbb898ce93366068ab82bf9ce992d89db39ed3052d0a41d20fe9cb39945bf44
...
COPY --chmod=0755 scripts/entrypoint-plain.sh /usr/local/bin/lima-entrypoint
